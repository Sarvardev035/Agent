let audioCtx = null;
let isMuted = typeof window !== 'undefined' && window.localStorage.getItem('finly_muted') === 'true';
const getCtx = () => {
...
const play = (frequency, duration, type = 'sine', volume = 0.3, delay = 0) => {
