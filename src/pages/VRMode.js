...
const VRMode = () => {
    ...
    useEffect(() => {
        ...
        const cards = [];
        const makeCard = (label, value, color, position) => {
            ...
            const textPlane = new THREE.Mesh(new THREE.PlaneGeometry(3.0, 1.3), new THREE.MeshBasicMaterial({ map: textTexture, transparent: true }));
        ...
        void loadData();
        const orb = new THREE.Mesh(new THREE.SphereGeometry(0.5, 32, 32), new THREE.MeshPhongMaterial({
            color: 0x7c3aed,
        ...
        scene.add(orb);
        const ring = new THREE.Mesh(new THREE.TorusGeometry(1, 0.02, 8, 60), new THREE.MeshBasicMaterial({
            color: 0x7c3aed,
            transparent: true,
            opacity: 0.5,
        }));
    ...
    return (_jsxs("div", { style: { position: 'relative', width: '100%', height: '100vh' }, children: [_jsx("div", { ref: mountRef, style: { width: '100%', height: '100%' } }), _jsx("div", { style: {
                    position: 'absolute',
                    top: 20,
                    left: 0,
                    right: 0,
                    ...
                    pointerEvents: 'none',
                        ...
                        fontSize: 14,
                        fontWeight: 600,
                    }, children: "\uD83E\uDD7D Finly VR Dashboard \u2014 Drag to explore \u00B7 Real data" }) }), _jsx("button", { onClick: () => window.history.back(), style: {
                    position: 'absolute',
                    top: 20,
                    right: 20,
                    ...
                    fontSize: 13,
                    fontWeight: 600,
                }, children: "\u2715 Exit VR" }), _jsx("div", { style: {
                    position: 'absolute',
                    bottom: 20,
                    left: 0,
                    right: 0,
                    ...
                    fontSize: 12,
                }, children: "\uD83D\uDDB1 Drag to rotate \u00B7 \uD83D\uDCF1 Touch & drag on mobile \u00B7 \uD83E\uDD7D VR headset supported" })] }));
};
